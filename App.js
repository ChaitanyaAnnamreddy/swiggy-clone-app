...
import { Input, Card, Image, Carousel, Tabs, Layout } from 'antd'
import {
  HomeOutlined,
  ContactsOutlined,
  UserOutlined,
...
const getImageUrl = (id) =>
  `https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/${id}`
...
const RestaurantsList = [
  {
    ...
    analytics: {
      context: 'seo-data-e3cdb34c-4c7b-492e-8586-a17430d0696a',
    },
    cta: {
